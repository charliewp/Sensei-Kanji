...
def node(request):
    if request.method == 'GET':
        ...
        return render(request, 'node.html',  {'chartdefs': chartdefs, 'fills': fills, 'units': units, 'location': location, 'data': data, 'series': series, 'yaxis_labels': yaxis_labels, 'colors': colors})
